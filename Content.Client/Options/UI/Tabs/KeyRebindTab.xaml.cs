...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        {
            if (_cfg.GetCVar(GameConfigVars.ToggleWalk))
            {
        ...
        {
            _cfg.SetCVar(GameConfigVars.ToggleWalk, args.Pressed);
            _cfg.SaveToFile();
            InitToggleWalk();
        ...
        public KeyRebindTab()
        {
            ...
            AddCheckBox("ui-options-hotkey-toggle-walk", _cfg.GetCVar(GameConfigVars.ToggleWalk), HandleToggleWalk);
            InitToggleWalk();
        ...
        private sealed class KeyControl : Control
        {
            ...
            public KeyControl(KeyRebindTab parent, BoundKeyFunction function)
            {
                ...
                BindButton1 = new BindButton(parent, this);
                BindButton2 = new BindButton(parent, this);
                ResetButton = new Button { Text = Loc.GetString("ui-options-bind-reset") };
