...
namespace Content.Client.ContextMenu.UI
{
    ...
    public sealed partial class EntityMenuUIController : UIController, IOnStateEntered<GameplayState>, IOnStateExited<GameplayState>
    {
        ...
        {
            _updating = true;
            _cfg.OnValueChanged(GameConfigVars.EntityMenuGroupingType, OnGroupingChanged, true);
        ...
        public void OnStateExited(GameplayState state)
        {
            _updating = false;
            Elements.Clear();
            _cfg.UnsubValueChanged(GameConfigVars.EntityMenuGroupingType, OnGroupingChanged);
            _context.OnContextKeyEvent -= OnKeyBindDown;
        ...
        public void OpenRootMenu(List<EntityUid> entities)
        {
            ...
            orderedStates.Sort((x, y) => string.Compare(
                _entityManager.GetComponent<MetaDataComponent>(x.First()).EntityName,
                _entityManager.GetComponent<MetaDataComponent>(y.First()).EntityName,
        ...
        private bool HandleOpenEntityMenu(in PointerInputCmdHandler.PointerInputCmdArgs args)
        {
            ...
            if (_examineSystem.TryGetEntityMenuEntities(coords, out var entities))
