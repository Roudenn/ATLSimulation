...
public sealed class TargetOutlineSystem : EntitySystem
{
    ...
    public void Enable(float range, Func<EntityUid, bool>? predicate, EntityWhitelist? whitelist, EntityWhitelist? blacklist, CancellableEntityEventArgs? validationEvent)
    {
        Range = range;
        Predicate = predicate;
        Whitelist = whitelist;
