...
public sealed class InteractionOutlineSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_configManager, GameConfigVars.OutlineEnabled, SetCvarEnabled);
    ...
    public override void FrameUpdate(float frameTime)
    {
        ...
        if (entityToClick == _lastHoveredEntity)
        {
            ...
            {
                outline.UpdateInRange(entityToClick.Value, true, renderScale);
            }
        ...
        {
            outline.OnMouseEnter(_lastHoveredEntity.Value, true, renderScale);
        }
    }
}
